...
void CShapeEx::DrawSelected(HDC hdc)
{
	...
	::LineTo(hdc,_nRight-1, _nTop);
	::LineTo(hdc,_nRight-1, _nBottom-1);
	::LineTo(hdc,_nLeft, _nBottom-1);
	::LineTo(hdc,_nLeft, _nTop);
...
void CShapeEx::OnLButtonUp(UINT nFlags, CPoint point)
{
